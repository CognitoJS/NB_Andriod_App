...
class AdminSale extends StatefulWidget {
  const AdminSale({super.key});

  @override
  State<AdminSale> createState() => _AdminSaleState();
}

class _AdminSaleState extends State<AdminSale> {
