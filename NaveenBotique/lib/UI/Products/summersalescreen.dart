...
class SummerSaleScreen extends StatefulWidget {
  const SummerSaleScreen({super.key});

  @override
  State<SummerSaleScreen> createState() => _SummerSaleScreenState();
}

class _SummerSaleScreenState extends State<SummerSaleScreen> {
