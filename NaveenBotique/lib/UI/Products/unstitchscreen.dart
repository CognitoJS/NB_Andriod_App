...
class UnStitched extends StatefulWidget {
  const UnStitched({super.key});

  @override
  State<UnStitched> createState() => _UnStitchedState();
}

class _UnStitchedState extends State<UnStitched> {
  String _imageUrl = "";
  List<ProductModel> productmodel = [];
  fetchRecords() async {
    var records =
        await FirebaseFirestore.instance.collection("Un Stitched").get();
    mapRecords(records);
  }
