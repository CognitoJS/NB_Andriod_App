...
class WeddingWear extends StatefulWidget {
  const WeddingWear({super.key});

  @override
  State<WeddingWear> createState() => _WeddingWearState();
}

class _WeddingWearState extends State<WeddingWear> {
  String _imageUrl = "";
  List<ProductModel> productmodel = [];
  fetchRecords() async {
    var records =
        await FirebaseFirestore.instance.collection("Wedding Wear").get();
    mapRecords(records);
  }
