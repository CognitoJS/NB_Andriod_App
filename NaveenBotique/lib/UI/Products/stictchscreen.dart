...
class Stitched extends StatefulWidget {
  const Stitched({super.key});

  @override
  State<Stitched> createState() => _StitchedState();
}

class _StitchedState extends State<Stitched> {
  String _imageUrl = "";
  List<ProductModel> productmodel = [];
  fetchRecords() async {
    var records = await FirebaseFirestore.instance.collection("Stitched").get();
    mapRecords(records);
  }
