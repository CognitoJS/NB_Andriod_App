...
class FestivalCollectionScreen extends StatefulWidget {
  const FestivalCollectionScreen({super.key});

  @override
  State<FestivalCollectionScreen> createState() =>
      _FestivalCollectionScreenState();
}

class _FestivalCollectionScreenState extends State<FestivalCollectionScreen> {
